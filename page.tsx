...
export default function EcoPortHomePage() {
  return (
    <div className="min-h-screen bg-white text-gray-800 p-6">
      ...
      <section className="max-w-4xl mx-auto mb-16">
        ...
        <a
          ...
          className="inline-block bg-blue-600 text-white px-6 py-3 rounded-2xl font-semibold shadow hover:bg-blue-700 transition"
        >
          Contact Us
        </a>
      </section>
